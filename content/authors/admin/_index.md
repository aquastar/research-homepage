...
{{% callout note %}}
Check my [office hours](https://zhiqian.youcanbook.me/) for meeting.  
...
* `[Paper]` 10/23:  Theoretical Framework for Unifying GNN accepted by **ACM Computing Survey** i﻿s online, see [paper](https://dl.acm.org/doi/10.1145/3627816), and {{% staticref "csur.pdf" "newtab" %}}slide{{% /staticref %}} 
